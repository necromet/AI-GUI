...
function buildCardPreview(files?: LibraryComponentFile[], componentId?: string): string | null {
...
export const ComponentCard: React.FC<ComponentCardProps> = ({
  ...
  const previewHtml = useMemo(() => buildCardPreview(comp.files, comp.id), [comp.files, comp.id]);
