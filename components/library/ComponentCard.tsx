...
function buildCardPreview(files?: LibraryComponentFile[], componentId?: string, category?: string): string | null {
  ...
  if (category === 'theme') {
    ...
    return `<!DOCTYPE html><html${hasDark ? ' class="dark"' : ''}><head><meta charset="UTF-8"><script src="https://cdn.tailwindcss.com"></script><style>${css}*{margin:0;padding:0;box-sizing:border-box}body{font-family:var(--font-sans,system-ui);background:var(--background,#fff);color:var(--foreground,#333);padding:1rem;min-height:100vh;overflow:hidden}</style></head><body><div style="display:flex;gap:0.5rem;margin-bottom:0.75rem;flex-wrap:wrap"><span style="background:var(--primary,#8839ef);color:var(--primary-foreground,#fff);padding:0.25rem 0.625rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Primary</span><span style="background:var(--secondary,#ccd0da);color:var(--secondary-foreground,#333);padding:0.25rem 0.625rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Secondary</span><span style="background:var(--accent,#04a5e5);color:var(--accent-foreground,#fff);padding:0.25rem 0.625rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Accent</span><span style="background:var(--destructive,#d20f39);color:var(--destructive-foreground,#fff);padding:0.25rem 0.625rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Destructive</span></div><div style="background:var(--card,#fff);color:var(--card-foreground,#333);border:1px solid var(--border,#ddd);border-radius:var(--radius,6px);padding:0.875rem;margin-bottom:0.75rem;box-shadow:0 var(--shadow-offset-y,4px) var(--shadow-blur,6px) var(--shadow-spread,0px) var(--shadow-color,rgba(0,0,0,0.1))"><div style="font-size:0.875rem;font-weight:700;margin-bottom:0.125rem">Card Title</div><div style="font-size:0.6875rem;color:var(--muted-foreground,#888);margin-bottom:0.75rem">Styled with theme variables</div><div style="display:flex;gap:0.375rem"><button style="background:var(--primary,#8839ef);color:var(--primary-foreground,#fff);border:none;padding:0.375rem 0.75rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Button</button><button style="background:transparent;color:var(--foreground,#333);border:1px solid var(--border,#ddd);padding:0.375rem 0.75rem;border-radius:var(--radius,6px);font-size:0.6875rem;font-weight:600">Outline</button></div></div><div style="display:flex;gap:0.375rem;align-items:center"><div style="width:1.25rem;height:1.25rem;border-radius:var(--radius,6px);background:var(--chart-1,#8839ef)"></div><div style="width:1.25rem;height:1.25rem;border-radius:var(--radius,6px);background:var(--chart-2,#04a5e5)"></div><div style="width:1.25rem;height:1.25rem;border-radius:var(--radius,6px);background:var(--chart-3,#40a02b)"></div><div style="width:1.25rem;height:1.25rem;border-radius:var(--radius,6px);background:var(--chart-4,#fe640b)"></div><div style="width:1.25rem;height:1.25rem;border-radius:var(--radius,6px);background:var(--chart-5,#dc8a78)"></div><span style="font-size:0.625rem;color:var(--muted-foreground,#888);margin-left:0.375rem">Charts</span></div></body></html>`;
  }
