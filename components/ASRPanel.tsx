      ...
      {inputMode === 'upload' ? (
        <div>
          ...
          {!audioFile ? (
            ...
            <Card className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-white/[0.03]">
              ...
              <Button variant="ghost" size="icon" onClick={handleRemoveFile} className="h-7 w-7 text-gray-500 hover:text-red-400">
                <X size={14} />
              </Button>
            </Card>
          )}
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <Button
              ...
              size="sm"
              onClick={handleCopy}
              className="flex items-center gap-1.5 px-2.5 py-1 h-auto text-xs text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
            >
          ...
          <Card>
            <CardContent className="p-4 text-sm text-gray-900 dark:text-gray-200 whitespace-pre-wrap leading-relaxed">
              {transcription}
            </CardContent>
          </Card>
        </div>
