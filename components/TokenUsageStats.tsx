  ...
  const loadStats = async () => {
    ...
    try {
      const [overall, models, dates, conversations] = await Promise.all([
        ...
        db.getTokenStatsByDate(Number(timeRange)),
          ...
          <div className="px-6 pt-4">
            <TabsList className="bg-transparent gap-1 h-auto p-0">
              {[
                ...
                { id: 'models' as const, label: 'By Model', icon: Zap },
                ...
                <TabsTrigger
                  key={id}
                  value={id}
                  className="relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 data-[state=active]:shadow-none"
                  style={{
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {isLoading ? (
              ...
              <>
                <TabsContent value="overview" className="mt-0 focus-visible:ring-0 focus-visible:outline-none">
                  {overallStats && (
                    <div className="space-y-6 animate-fade-in">
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                          ...
                          <Card
                            key={i}
                            className={cn(
                              "relative bg-gradient-to-br border backdrop-blur-sm group hover:scale-[1.02] transition-all duration-300",
                              metric.gradient,
                              metric.borderColor
                            )}
                          >
                      ...
                      <Card className="bg-gray-50/50 dark:bg-white/[0.02]">
                        <CardHeader>
                          <CardTitle className="text-sm font-semibold uppercase tracking-wider">Usage Breakdown</CardTitle>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="models" className="mt-0 focus-visible:ring-0 focus-visible:outline-none">
                  {(() => {
                          ...
                          {mergedModels.map((model, index) => {
                            ...
                            return (
                              <Card
                                ...
                                className="hover:border-gray-300 dark:hover:border-white/[0.1] transition-all duration-300 hover:shadow-lg group bg-white dark:bg-white/[0.02]"
                              >
                                <CardContent className="p-5">
                                  <div className="flex items-center gap-4">
                ...
                <TabsContent value="timeline" className="mt-0 focus-visible:ring-0 focus-visible:outline-none">
                    ...
                    {dateStats.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {dateStats.map((stat, index) => {
                          ...
                          return (
                            <Card key={index} className="bg-white dark:bg-white/[0.02] hover:border-gray-300 dark:hover:border-white/[0.08] transition-all">
                ...
                <TabsContent value="conversations" className="mt-0 focus-visible:ring-0 focus-visible:outline-none">
                    ...
                    {conversationStats.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {conversationStats.map((conv) => (
                          <Card key={conv.conversationId} className="bg-white dark:bg-white/[0.02] hover:border-gray-300 dark:hover:border-white/[0.08] transition-all">
                            <CardContent className="p-4">
