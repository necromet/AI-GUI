  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={addVariable} className="text-xs flex items-center gap-1 cursor-pointer transition-colors hover:scale-105 active:scale-95" style={{ color: 'var(--neon-color)' }}>
          <Plus size={12} /> Add
        </button>
      </div>
      <AnimatePresence>
        {variables.map((v, i) => (
          ...
          >
            <div className="flex gap-2 items-start p-2.5 rounded-lg border mb-2" style={{ borderColor: 'var(--border-300)' }}>
              ...
              <button onClick={() => removeVariable(i)} className="p-1 cursor-pointer transition-colors hover:bg-[var(--bg-300)] rounded" style={{ color: 'var(--text-500)' }}>
                <X size={12} />
              </button>
            </div>
          </motion.div>
