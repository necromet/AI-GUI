...
import { buildSpecSystemPrompt } from '../services/stitchSpecPrompt';
import * as stitchDb from '../db/stitchProjects';
import * as library from '../services/stitchLibraryService';
...
router.get('/projects', (_req: Request, res: Response) => {
  try {
    const projects = stitchDb.getStitchProjects();
    res.json({ projects });
  } catch (error: any) {
    console.error('[stitch/projects GET] Error:', error.message);
...
router.get('/projects/:id', (req: Request, res: Response) => {
  try {
    const project = stitchDb.getStitchProject(req.params.id);
    if (!project) {
    ...
    console.error('[stitch/projects/:id GET] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.put('/projects/:id', (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/projects/:id PUT] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.delete('/projects/:id', (req: Request, res: Response) => {
  try {
    stitchDb.deleteStitchProject(req.params.id);
    res.json({ success: true });
  } catch (error: any) {
    console.error('[stitch/projects/:id DELETE] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/generate-spec', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/generate-spec] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.get('/components', (req: Request, res: Response) => {
  try {
    ...
    const components = library.listComponents({ category, projectType });
    res.json({ components });
  } catch (error: any) {
    console.error('[stitch/components GET] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.get('/components/:id', (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components/:id GET] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/components', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components POST] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.delete('/components/:id', (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components/:id DELETE] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/components/search', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components/search POST] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/components/reindex', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components/reindex POST] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/components/seed', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[stitch/components/seed POST] Error:', error.message);
    res.status(500).json({ error: error.message });
  }
});
